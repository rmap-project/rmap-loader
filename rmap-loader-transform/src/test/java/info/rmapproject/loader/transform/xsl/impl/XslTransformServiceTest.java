...
import info.rmapproject.loader.camel.impl.SuppliedContextFactory;
...
public class XslTransformServiceTest extends CamelTestSupport {
    ...
    @Before
    public void setup() {
        final ContextFactory factory = new SuppliedContextFactory(context);
        toTest.setContextFactory(factory);
