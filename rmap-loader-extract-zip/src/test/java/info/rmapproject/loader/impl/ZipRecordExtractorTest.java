...
import info.rmapproject.loader.impl.file.ZipRecordExtractor;

/**
 * @author apb@jhu.edu
 */
public class ZipRecordExtractorTest {
    ...
    public void contentTypeTest() throws Exception {
        ...
        final Set<String> zippedcontentTypes = new ZipRecordExtractor()
    ...
    public void uniqueRecordIdTest() throws Exception {
        final Set<String> zippedRecordIDs = new ZipRecordExtractor()
                .recordsFrom(zipfile.toPath())
